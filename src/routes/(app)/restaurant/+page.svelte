...
<style>
  ...
  .profile-sections { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 28px; }
  .profile-section { min-width: 0; display: grid; align-content: start; gap: 14px; }
  .profile-section + .profile-section { padding-left: 28px; border-left: 1px solid var(--cl-line); }
  ...
  .logo-field { display: grid; grid-template-columns: 74px minmax(0, 1fr) auto; align-items: center; gap: 16px; padding-bottom: 22px; border-bottom: 1px solid var(--cl-line); }
  ...
  @media (max-width: 980px) {
    ...
    .profile-section + .profile-section { padding-top: 22px; padding-left: 0; border-top: 1px solid var(--cl-line); border-left: 0; }
  }
