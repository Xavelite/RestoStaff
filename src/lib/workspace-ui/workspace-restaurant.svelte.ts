...
/**
 * The restaurant configuration being edited in the workspace Restaurant module.
 *
 ...
 */
class WorkspaceRestaurantDraft {
...
export const restaurantConfig = new WorkspaceRestaurantDraft();
