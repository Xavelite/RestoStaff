...
(function(){
  ...
  const paths = {
    ...
    medical:'<path d="M12 5v14M5 12h14"></path><rect x="4" y="4" width="16" height="16" rx="5"></rect>',
    ...
    palm:'<path d="M12 21c1.2-5.4 1.1-10.1-.3-14"></path><path d="M12 7c-3.6-1.6-6.3-.8-8 2.4 3.4.1 6 .6 8 2"></path><path d="M12 7c2.3-3.1 5-3.8 8-2.2-2 2.2-4.6 3.4-8 3.9"></path><path d="M12 7c-.2-3.2 1.2-5 4-5.5.2 2.4-1 4.3-4 5.5"></path>',
  ...
  const statusMap = {
    ...
    missing:{tone:'warn', icon:'alert', label:'Missing information'},
    warning:{tone:'warn', icon:'alert', label:'Warning'},
    issue:{tone:'warn', icon:'alert', label:'Issue'},
    pending:{tone:'warn', icon:'timer', label:'Pending'},
    ...
    draft:{tone:'warn', icon:'edit', label:'Draft'},
