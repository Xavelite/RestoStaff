...
(function(){
  ...
  const modules = [
    ...
    {title:'Time Clock',subtitle:'Track time easily',color:'#54d1b4',glow:'rgba(84,209,180,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><circle cx="24" cy="24" r="15"/><path d="M24 16v9l6 5"/><path d="M24 9v2M24 37v2M39 24h-2M11 24H9"/></svg>`},
    {title:'Costs',subtitle:'Control expenses',color:'#58d28a',glow:'rgba(88,210,138,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M10 35V22"/><path d="M19 35V16"/><path d="M28 35V25"/><path d="M37 35V12"/><circle cx="36" cy="32" r="6"/><path d="M36 29v6M33 32h6"/></svg>`},
    {title:'Daily Close',subtitle:'Cash & payments',color:'#45c5ec',glow:'rgba(69,197,236,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><rect x="9" y="13" width="30" height="22" rx="6"/><path d="M15 20h18M15 27h12"/><rect class="fill" x="29" y="24" width="6" height="7" rx="2"/></svg>`},
    {title:'Inventory',subtitle:'Manage stock',color:'#8298ff',glow:'rgba(130,152,255,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M13 16 24 10l11 6v16l-11 6-11-6V16Z"/><path d="M13 16l11 6 11-6M24 22v16"/><path d="M31 31l3 3 6-7"/></svg>`},
    {title:'Team / HR',subtitle:'Manage your team',color:'#8f74ff',glow:'rgba(143,116,255,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><circle cx="18" cy="18" r="6"/><circle cx="31" cy="20" r="5" opacity=".7"/><path d="M8 36c1.6-5.4 5.8-8 10-8s8.4 2.6 10 8"/><path d="M26 36c1.1-3.8 4-5.8 7-5.8 2.4 0 4.8 1.1 6 3.2"/></svg>`},
    {title:'Forecast',subtitle:'Covers & service',color:'#3ed4c1',glow:'rgba(62,212,193,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M10 34V18"/><path d="M19 34V22"/><path d="M28 34V15"/><path d="M37 34V24"/><path d="M11 29c4-4 8-8 13-8s7 2 11 2 6-2 9-5"/></svg>`},
    {title:'Exports',subtitle:'Reports & files',color:'#f27da0',glow:'rgba(242,125,160,.17)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M16 10h11l7 7v21H16z"/><path d="M27 10v8h7"/><path d="M24 24v10"/><path d="M20 30l4 4 4-4"/></svg>`},
    {title:'Setup',subtitle:'Restaurant config',color:'#a7b3c5',glow:'rgba(167,179,197,.17)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><circle cx="24" cy="24" r="6"/><path d="M24 10v5M24 33v5M38 24h-5M15 24h-5M33.9 14.1l-3.5 3.5M17.6 30.4l-3.5 3.5M33.9 33.9l-3.5-3.5M17.6 17.6l-3.5-3.5"/></svg>`}
  ];
