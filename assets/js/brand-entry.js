...
(function(){
  ...
  const modules = [
    ...
    {title:'Badge Terminal',subtitle:'Tablet clock-in',color:'#58d28a',glow:'rgba(88,210,138,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M10 35V22"/><path d="M19 35V16"/><path d="M28 35V25"/><path d="M37 35V12"/><circle cx="36" cy="32" r="6"/><path d="M36 29v6M33 32h6"/></svg>`},
    ...
    {title:'Insights',subtitle:'Costs & availability',color:'#3ed4c1',glow:'rgba(62,212,193,.18)',icon:`<svg class="brand-module-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M10 34V18"/><path d="M19 34V22"/><path d="M28 34V15"/><path d="M37 34V24"/><path d="M11 29c4-4 8-8 13-8s7 2 11 2 6-2 9-5"/></svg>`},
