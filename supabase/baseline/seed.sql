...
values
  ...
  ('published_planning_changed', 'manager', 'Published schedule changed', 'A published schedule was changed.', 'route', 'schedule', false, false, 120, true),
  ('payroll_export_created', 'manager', 'Payroll export created', 'A payroll export was created.', 'route', 'timesheet', false, false, 130, true),
  ...
  ('shift_changed_after_publication', 'employee', 'Shift changed after publication', 'A published shift was changed.', 'route', 'my-service', false, false, 260, true)
